...
import { router_weather } from "./Routers/utils/weather";
...
<div class="container">
    ...
    <div class="endpoint-list">
        ...
        <ul>
            ...
            <li>
                <a href="/api/utils/weather">Weather</a>
                <details>
                    <summary>Information</summary>
                    <p>This endpoint retrieves weather information for a specified location.</p>
                    <h2>How to use ? :</h2>
                    <p>http://localhost:8080/api/utils/weather?q=your_city</p>
                </details>
            </li>
        </ul>
    </div>
